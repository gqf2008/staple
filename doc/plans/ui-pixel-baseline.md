...
- [x] F3 侧栏（issue #237 + #244）：默认 240px + 折叠 rail 64px（#sidebar-toggle + localStorage，折叠后隐藏文本残片）；拖拽调整宽度已实现（#sidebar-resizer，208–420px 夹紧 + localStorage 持久化）；≤48rem 窄屏自动折叠为 rail 64px。
