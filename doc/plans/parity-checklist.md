...
> 2026-08-07 UI 对齐落地：A 视觉 token 层（#236/#239）、B 布局与组件规格（#237/#241）、C 上游 Storybook 运行时截图基线（#238/#240）、D 深色主题（#242，`.dark` token + system/light/dark 切换 + 防 FOUC）全部完成；剩余差异为 Topcoat SSR 架构性限制（侧栏拖拽尺寸、SPA 动画/乐观更新/skeleton、移动端适配），已登记。
