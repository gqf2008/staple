...
export function Companies() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("pages.companies.title", { defaultValue: "Companies" }) }]);
  }, [setBreadcrumbs]);
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t("pages.companies.agentsCount", { count: agentCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {t("pages.companies.tasksCount", { count: issueCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    ...
                    {company.budgetMonthlyCents > 0
                      ...
                      : <span className="text-xs ml-1">{t("common.unlimitedBudget", { defaultValue: "Unlimited budget" }) as unknown as React.ReactNode}</span>}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 ml-auto">
                  <Calendar className="h-3.5 w-3.5" />
                  <span>{t("pages.companies.created", { time: relativeTime(company.createdAt) })}</span>
                </div>
              </div>
