...
const sections: ShortcutSection[] = [
  {
    ...
    shortcuts: [
      ...
      { keys: [t("ui.components.keyboardshortcutscheatsheet.enter")], label: t("components.keyboardShortcuts.openItem", { defaultValue: "Open selected item" }) },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ["k"], label: t("components.keyboardShortcuts.moveUp", { defaultValue: "Move up" }) },
      { keys: ["↑"], label: t("components.keyboardShortcuts.moveUp", { defaultValue: "Move up" }) },
      { keys: [t("ui.components.keyboardshortcutscheatsheet.enter")], label: t("components.keyboardShortcuts.toggleDecision", { defaultValue: "Open or close selected decision" }) },
