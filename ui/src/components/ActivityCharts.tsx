...
export function RunActivityChart(props: RunChartProps) {
  ...
  if (!hasData) return <p className="text-xs text-muted-foreground">{t("components.activityCharts.noRuns", { defaultValue: "No runs yet" })}</p>;
...
const statusLabels: Record<string, string> = {
  todo: t("components.activityCharts.todo", { defaultValue: "To Do" }),
  in_progress: t("components.activityCharts.inProgress", { defaultValue: "In Progress" }),
  in_review: t("components.activityCharts.inReview", { defaultValue: "In Review" }),
  done: t("components.activityCharts.done", { defaultValue: "Done" }),
  blocked: "Blocked",
  cancelled: t("components.activityCharts.cancelled", { defaultValue: "Cancelled" }),
  backlog: t("components.activityCharts.backlog", { defaultValue: "Backlog" }),
};
