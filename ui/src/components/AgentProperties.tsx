    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1">
        ...
        {runtimeState?.lastError && (
          <PropertyRow label={lastErrorIsActive ? t("components.agentProperties.lastError", { defaultValue: "Last error" }) : t("components.agentProperties.lastRunError", { defaultValue: "Last run error" })}>
            <span
              className={
                lastErrorIsActive
